...
/**
 * A helper to read cs3500.exportAnimation data and construct an cs3500.exportAnimation from it.
 */
public class AnimationReader {
   ...
   * <ul>
   * <li>cs3500.Shape lines: the keyword "cs3500.shape" followed by two identifiers (i.e.
   * alphabetic strings with no spaces), giving the unique name of the cs3500.shape, and the type of
   * cs3500.shape it is.</li>
   * <li>Motion lines: the keyword "motion" followed by an identifier giving the name of the
   * cs3500.shape to move, and 16 integers giving the initial and final conditions of the motion:
   ...
   * </p>
   *
   * @param readable The source of data for the cs3500.exportAnimation
   * @param builder  A builder for helping to construct a new cs3500.exportAnimation
  ...
  private static <Doc> void readMotion(Scanner s, AnimationBuilder<Doc> builder) {
    String[] fieldNames = new String[]{ "initial time", "initial x-coordinate",
            "initial y-coordinate", "initial width", "initial height", "initial red value",
            "initial green value", "initial blue value", "final time", "final x-coordinate",
            "final y-coordinate", "final width", "final height", "final red value",
            "final green value", "final blue value",
    };
    int[] vals = new int[16];
    String name;
    if (s.hasNext()) {
